-- ════════════════════════════════════════════════════════════════
-- 061 — سجل التدقيق: تغطية الاجتماعات
-- ════════════════════════════════════════════════════════════════
-- كانت جداول الاجتماعات خارج مُحفِّز التدقيق. هذا الترحيل:
--   • يوسّع audit_row_change لاستنتاج school_id لحضور/محاضر الاجتماعات
--     عبر الاجتماع الأب.
--   • يربط مُحفِّز zz_audit بـ meetings/meeting_attendees/meeting_notes/group_meetings.
-- (الدالة هنا تُستبدَل لاحقاً في 062 — تُحتفظ للسجل.)
-- ════════════════════════════════════════════════════════════════
...
DO $do$
DECLARE t text;
  tables text[] := ARRAY['meetings','meeting_attendees','meeting_notes','group_meetings'];
BEGIN
