...
- خانة "الفترة الزمنية" لكل فعالية إما خلية واحدة أو خليتان. افحص بدقة عدد الخلايا قبل الاستخراج:
  • إن كانت مقسومة إلى خليتين (تاريخان): الخلية اليمنى = تاريخ البدء (start_date)، والخلية اليسرى = تاريخ الانتهاء (end_date). التاريخان مختلفان حتماً — يُمنع تكرار نفس التاريخ في الحقلين.
  • إن كانت خلية واحدة فقط (تاريخ واحد): اجعل start_date = end_date.
- قاعدة تحقق إلزامية: لا تكتب start_date = end_date إلا إذا تأكدت أن الخانة خلية واحدة. وجود تاريخين في الصف يعني نطاقاً، فاستخرجهما كليهما.
- تذكّر: تاريخ البدء (اليمين) غالباً أبكر من تاريخ الانتهاء (اليسار). إن وجدت تاريخين فالأصغر/الأبكر هو البدء والأكبر/الأحدث هو الانتهاء.
- انتبه لتنسيق التواريخ العربية (يوم / شهر / سنة) وأسماء الأشهر العربية (يناير=01 ... ديسمبر=12). انتبه لاختلاف الشهر بين الخليتين (مثل 27 يونيو → 19 أغسطس).
