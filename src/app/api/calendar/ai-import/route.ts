...
- مهم جداً: عمود "الفترة الزمنية" غالباً يحتوي تاريخين منفصلين (نطاق): الأيمن/الأول هو البداية، والأيسر/الثاني هو النهاية. اقرأ كلا التاريخين بدقة ولا تكرّر تاريخ البدء في خانة الانتهاء.
- مثال: "23 أغسطس 2026 ← 27 أغسطس 2026" تعني start_date=2026-08-23 و end_date=2026-08-27 (مختلفان).
- اجعل start_date = end_date فقط عندما يحتوي الصف على تاريخ واحد حقيقي (يوم واحد) دون نطاق.
