...
### اليوم 5 — الخميس | الاستضافة + إصلاح البريد
**الوقت المقدر:** 2-3 ساعات
...
- [ ] تحديث `src/app/api/notifications/email/route.ts` السطر 24:
  ...
  - أو تعليق ميزة البريد مؤقتاً حتى يُشترى النطاق
- [ ] Push + نشر

**✅ نهاية الأسبوع الأول:**
الثغرات الأمنية الحرجة مغلقة، البيانات معزولة بالمدرسة، الاستضافة مستقرة.
